...
set path[12]=AppData\Local\Macro_Deck\Macro_Deck_2_Url_vfpjnpinx3jslgeip5wgbsz511kvbm11\2.21.3110.100
set path[13]=AppData\Local\Meltytech\Shotcut
set path[14]=AppData\Local\Microsoft\Credentials
set path[15]=AppData\Local\Microsoft\Windows\Cursors
set path[16]=AppData\Local\Microsoft\Windows\Fonts
set path[17]=AppData\Local\oh-my-posh
set path[18]=AppData\Local\Packages\Microsoft.WindowsTerminal_8wekyb3d8bbwe\LocalState
...
set path[26]=AppData\Roaming\espanso
set path[27]=AppData\Roaming\flameshot
set path[28]=AppData\Roaming\FileZilla
set path[29]=AppData\Roaming\Google
set path[30]=AppData\Roaming\Insomnia
set path[31]=AppData\Roaming\JAM Software
set path[32]=AppData\Roaming\LGHUB
set path[33]=AppData\Roaming\Logishrd
set path[34]=AppData\Roaming\Macro Deck
set path[35]=AppData\Roaming\Microsoft\Windows\PowerShell
set path[36]=AppData\Roaming\NetBeans
set path[37]=AppData\Roaming\Nucleo
